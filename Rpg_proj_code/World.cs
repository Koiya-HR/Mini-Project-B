...
public static class World
{
    ...
    {
        Monster rat = new Monster(MONSTER_ID_RAT, "rat", 1, 3, 3, 1, 5);


        Monster snake = new Monster(MONSTER_ID_SNAKE, "snake", 10, 7, 7, 5, 10);


        Monster giantSpider = new Monster(MONSTER_ID_GIANT_SPIDER, "giant spider", 3, 10, 10, 10, 15);
    ...
    public static void PopulateQuests()
    {
        ...
        // assign quests to locations
        LocationByID(LOCATION_ID_ALCHEMIST_HUT)!.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_ALCHEMIST_GARDEN)!;
        LocationByID(LOCATION_ID_FARMHOUSE)!.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_FARMERS_FIELD)!;
        LocationByID(LOCATION_ID_BRIDGE)!.QuestAvailableHere = QuestByID(QUEST_ID_COLLECT_SPIDER_SILK)!;
    }
